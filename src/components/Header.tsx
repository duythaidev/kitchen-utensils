...
const Header = () => {
  ...
  return (
    <>
      <header className="border fixed w-full bg-white z-20">
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <div className="relative">
              <button type="button" onMouseEnter={() => setShowNav(true)} onMouseLeave={() => setShowNav(false)} className="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" aria-expanded="false">
                Product
              ...
              <div className={`${ "hidd transition ease-in duration-150 opacity-100 translate-y-0"} absolute top-full -left-8 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5`}>
                <div className="p-4">
