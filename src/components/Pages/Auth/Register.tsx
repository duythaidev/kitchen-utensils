            ...
            <div className="bg-gray-100 flex min-h-[80vh] flex-col justify-center py-12 sm:px-6 lg:px-8 ">
                <div className="mt-8 sm:mx-auto sm:w-full md:w-1/3">
                    <div className="bg-white  px-4 pb-4 pt-8 sm:rounded-lg sm:px-10 sm:pb-6 sm:shadow">
                        ...
                        <div>
                            <button onClick={()=>signIn('google')} className="-2 bg-gray-50 cursor-pointer mt-8 w-full flex items-center justify-center rounded-md border border-gray-300 text-gray-500 px-4 py-2 outline-none ring-gray-400 ring-offset-2 transition hover:border-transparent hover:bg-black hover:text-white focus:ring-2">
                        ...
                        <div className="m-auto mt-6 w-fit md:mt-8">
                            <span className="m-auto text-gray-500">Already have an account?
                                <Link className="ml-2 hover:text-indigo-600 text-black" href="/login">Log in</Link>
                            </span>
                        </div>
                    </div>
                </div>
